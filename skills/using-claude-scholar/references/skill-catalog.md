...
| Skill | Trigger Condition |
|-------|-------------------|
| **using-claude-scholar** | Academic papers, research projects, scientific writing — enforces skill evaluation and policy compliance |
| **policy-rule-creator** | Creating new policy rules (requirements → Rule Card → Registry → Integration → validation) |

...
- **ML 会议**：无独立图规范，但审稿人在 100% 缩放下读 PDF——图内最小字号不小于正文脚注字号（对应 `FIG.FONT_GE_24PT` 的出图口径）。
...
4. 交叉核对 `FIG.VECTOR_FORMAT_REQUIRED`、`FIG.COLORBLIND_SAFE_PALETTE`、`FIG.FONT_GE_24PT`；出图后走 `figure-visual-qa.md` 闭环。

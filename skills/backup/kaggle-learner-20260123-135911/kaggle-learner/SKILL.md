...
|----------|-------|---------------|
| **NLP** | Text classification, NER, translation, LLM applications | `references/knowledge/nlp.md` |
| **CV** | Image classification, detection, segmentation, generation | `references/knowledge/cv.md` |
| **Time Series** | Forecasting, anomaly detection, sequence modeling | `references/knowledge/time-series.md` |
| **Tabular** | Feature engineering, traditional ML, structured data | `references/knowledge/tabular.md` |
| **Multimodal** | Cross-modal tasks, vision-language models | `references/knowledge/multimodal.md` |

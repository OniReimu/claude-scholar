...
- For conceptual diagrams in slides, use `paper-figure-generator` skill (generates editable SVG via AutoFigure-Edit)
...
- For key system/method figures, reuse or regenerate via `paper-figure-generator` skill (editable SVG output)
